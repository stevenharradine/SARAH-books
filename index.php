...
//			$endpoint = 'http://localhost/SARAH/apps/books/api/books/';
			$endpoint = 'https://localhost/SARAH/apps/books/api/books/';
			$username = 'books_user';
...
*/
			$listBooks_data = array (
				"myusername" => $username,
				"mypassword" => $password
			);
			$books = restServiceCall ($endpoint, $listBooks_data);
